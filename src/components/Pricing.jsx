    ...
    <section className="py-[60px]" id="pricing">
      ...
      <div className="max-w-wrap mx-auto px-10 max-sm:px-5 pt-12">
        <Reveal className="text-center max-w-[480px] mx-auto mb-3">
          <span className="text-xs font-medium text-muted-foreground tracking-[0.06em] uppercase mb-4 block">Pricing</span>
              ...
              >
                ...
                <div className="mb-6">
                  <div className="flex items-center gap-[7px] mb-1">
                    ...
                    <span className={`font-display text-[15px] font-bold tracking-[-0.01em] ${p.featured ? 'text-primary-foreground' : 'text-foreground'}`}>
                      {p.tier}
                    </span>
                  </div>
                  <div className={`text-[13px] font-normal ${p.featured ? 'text-primary-foreground/50' : 'text-muted-foreground'}`}>
                    {p.subtitle}
                  </div>
                </div>
                ...
                <div className="mb-5">
                  <div className="flex items-baseline gap-[6px]">
                    <span className={`font-sans text-[40px] leading-none tracking-[-0.03em] font-regular ${p.featured ? 'text-primary-foreground' : 'text-foreground'}`}>
                      {p.price}
                    </span>
                    <span className={`text-[13px] font-normal ${p.featured ? 'text-primary-foreground/50' : 'text-muted-foreground'}`}>
                      {p.per}
                    </span>
                  </div>
                </div>
                ...
                <ul className="list-none flex flex-col gap-[10px] flex-1">
                  {p.feats.map((f, j) => (
                    <li key={j} className={`flex items-start gap-[9px] text-[13px] font-normal leading-[1.5] ${p.featured ? 'text-primary-foreground/70' : 'text-muted-foreground'}`}>
                      <svg viewBox="0 0 24 24" strokeWidth={2.5} fill="none" style={{ width: 13, height: 13, flexShrink: 0, marginTop: 2, stroke: p.accent }}>
