...
const plans = [
  {
    ...
    feats: [
      ...
      "Team roles, task assignment & collaboration",
    ],
    cta: "Get started",
    featured: false,
  },
  {
    ...
    feats: [
      ...
      "Unlimited proposals & campaigns",
      "Calendar PDF export",
      "Recurring invoices & subscription tracking",
      "Accrual accounting toggle",
      "Client report generation",
      "Document collections",
      "Agency branding on client portals",
  ...
  },
  {
    ...
    feats: [
      ...
      "Full whitelabel — no Tercero branding anywhere",
      "Custom roles & granular permissions",
      "VIP concierge support & dedicated onboarding",
    ],
    cta: "Contact Team",
    featured: false,
  },
      ...
      <div className="max-w-wrap mx-auto px-10 max-sm:px-5 pt-12">
        <Reveal className="text-center max-w-[480px] mx-auto mb-3">
          ...
          <p className="text-sm font-medium text-foreground">
            Extra clients ₹500 / mo · Extra seats ₹399 / mo — on Ignite &
            Velocity. Custom on Quantum.
          </p>
        </Reveal>
