    ...
    <section className="py-20 text-center bg-foreground/[0.04]">
      <div className="max-w-wrap mx-auto px-10 max-sm:px-5">
        <Reveal>
          ...
          <h2 className="font-display text-[clamp(28px,3.5vw,46px)] font-extrabold leading-[1.1] tracking-[-0.03em] text-foreground max-w-[580px] mx-auto mb-4">
            Run your agency.
            <br />
            <em className="not-italic text-muted-foreground/60">Not your inbox.</em>
          </h2>
          ...
          <div className="flex items-center justify-center gap-3 flex-wrap">
            <Button asChild variant="default" className="text-base px-5 h-auto py-[9px] font-sans tracking-[-0.01em]">
              <a href={links.signup}>
                Start free trial
            ...
            <Button asChild variant="ghost" className="text-base px-5 h-auto py-[9px] text-muted-foreground font-sans">
