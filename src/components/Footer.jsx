  ...
  return (
    <footer className="pt-14 pb-9 border-t border-border">
      <div className="max-w-wrap mx-auto px-10 max-sm:px-5">
        <div className="flex justify-between gap-12 max-sm:flex-col max-sm:gap-8 mb-12">
          <div>
            <Logo />
        ...
        <div className="border-t border-border pt-6 flex items-center justify-between max-sm:flex-col max-sm:items-start max-sm:gap-1">
          <div className="text-xs text-muted-foreground">© 2025 Tercero. All rights reserved.</div>
          <div className="text-xs text-muted-foreground">Built for agency operators.</div>
        </div>
      </div>
    </footer>
  )
